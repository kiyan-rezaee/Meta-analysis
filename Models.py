models = [
    ...
    'mUSE', 'SBERT', 'CrystalFeel', 'NTN', 'GBRank', 'Markov blanket', 'Poisson Factorization'
]
...
pdfFileObj = open(
    "../Query_modeling_for_entity_search_based_o20160627-16959-xu6gpw-with-cover-page-v2.pdf",
    'rb')
