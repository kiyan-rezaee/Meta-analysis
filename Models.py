models = [
    ...
    'LambdaMART', 'RankNet', 'QCM', 'LightFM', 'ALS', 'CF', 'LR', 'PNN',
    'Deep&Cross', 'xDeepFM', 'FmFM', 'Distill', 'Query-question Matching',
    'Loss Function', 'pseudo-labels', 'k-means', 'Conv-KRNM', 'GraphConfRec',
    'DARWR', 'DAKATZ', 'CNAVER', 'DDTCDR', 'HAN', 'few-shot learning',
    'Siamese Network', 'R2D2', 'LSTM', 'GNNs', 'GPT-3', 'DisSig', 'TLGNN',
    'HyperGAT', 'NNID', 'Modeller Intention Detection', 'Model Validation',
    'Intention to Modelling Specification Mapping', 'TextCNN', 'KBRD',
    'COLING20', 'KGSF', 'CR-Walker', 'CRFR', 'DNN', 'uDin', 'NCF', 'KG-based',
    'LinUCB', 'ConUCB', 'GBFM', 'HOFMs', 'DeepFM', 'AutoFIS', 'MHA', 'NFM',
    'DSIN', 'AFM', 'Temporal Convolutional Network', 'SimNet', 'FINet',
    'WordNet-based', 'FM', 'Wide&Deep', 'AutoInt', 'AFN', 'PLM', 'QDM', 'MAUT',
    'AllenNLP', 'DHP', 'Max Category', 'MLP ', 'GBDT', 'XGBoost', 'icsiboost',
    'IGNet', 'Logistic Regression', 'Naive Bayes', 'Bubble filters',
    'Result Rank', 'Dwell Time', 'Re-ranking', 'Query filtering', 'CTW', 'DCM',
    'FCM', 'DAM', 'TransRec', 'GRU4Rec+', 'T-LSTM', 'QL', 'RM3', 'ERM', 'SDM',
    'BERT-NeuQS', 'LRS', 'MC', 'LOF', 'LMCL', 'BiLSTM', 'SVD++', 'CASER',
    'DIEN', 'RUM', 'SHAN', 'NeuMF', 'Markov', 'FOT', 'SI-Gamma', 'SI-Beta',
    'MI-Purchase and MI-Explore', 'TRLM', 'BOW', 'Multipartite graph', 'CMF',
    'CDAC', 'NMIR', 'BART', 'EAR', 'CRM', 'SasRec', 'GRU', 'GPT-2', 'RLC',
    'LEAM', 'Fast Text', 'ER', 'Micros', 'Macros', 'TextGCN', 'PTE', 'LSA',
