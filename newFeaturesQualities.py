...
features = [['Ranking'], ['Prediction'], ['behavior-based'], ['graph based'],
            ...
            ['Generative model'], ['Activity-based'
                                   ], ['hybrid recommendation'],
            ['co-occurrence'], ['semantic analysis'], ['Model-based'],
            ['Context-aware'], ['Query-based'], ['text similarity'],
            ['Smoothing'], ['Click-through'], ['rule-based tagging'],
            ['Multilingual'], ['Item recommendation'], ['Multidimensional'],
            ['Word cluster'], ['Location-based'], ['network architecture'],
            ['Pruning'], ['Ratings Prediction'], ['Attentive'],
            ['end-to-end approach'], ['Multimodal'], ['Query Suggestions'],
            ['Representation learning'], ['Memory-based approaches'],
            ['algorithm-agnostic'], ['Pre-trained Model'],
            ['Multi-criteria ratings'], ['time-based'], ['Session-based'],
            ['Negative feedback'], ['hierarchical clustering'],
            ['neighborhood-based'], ['Search trail'], ['time-aware'],
            ...
            ['image similarity'], ['template-based'], ['Subjective Questions'],
